...
# editdistance risk scorer 
editdistance_risk_scorer <- function(challenge_data_train, challenge_data_test,  out_dir){
  #######todo validate
  ...
  out <- list(challenge_data_train = challenge_data_train, 
              ...
              y=NULL,  
              new_data = NULL,
              out_dir=setup_outdir(out_dir, "editdistance_risk_scorer"),
              fit=NULL,
              x_predictions=NULL,
              new_data_predictions=NULL,
              x_predictions_score=NULL,
              new_data_predictions_score=NULL)
  class(out) <- "editdistance_risk_scorer"
...
run_pipeline.editdistance_risk_scorer  <- function(object){
  flog.info("Begin run_pipeline.editdistance_risk_scorer")
  ...
  flog.info("End run_pipeline.editdistance_risk_scorer")
  invisible(object)
...
summary.survivalanalysis_risk_scorer <- function(object){
  ...
  print("cox lasso coefficients")
  print(coefficients(object$fit))
  print("cox lasso coefficients penalied")
  print(coefficients(object$fit, "penalized"))
  print(basehaz(object$fit))
